...
const TABLE_DEFS: Record<string, { apiKey: string; label: string; navKey: string; columns: string[]; displayColumns: string[] }> = {
  countries: {
    ...
    displayColumns: ["id", "country_name", "country_code"],
  },
  destinations: {
    apiKey: "destination",
    label: "Destinations",
    ...
    displayColumns: ["id", "name", "type", "country_id"],
  },
  resorts: {
    apiKey: "resorts",
    label: "Resorts",
    ...
    displayColumns: ["id", "name", "destination_id"],
  },
  "accommodation-types": {
  ...
  "accommodation-list": {
    ...
    displayColumns: ["id", "type_id", "name", "resorts_id", "description"],
  },
  "board-basis": {
    apiKey: "board_basis",
    label: "Board Basis",
  ...
  "package-commissions": {
    ...
    displayColumns: ["id", "package_type_id", "tour_operator_id", "percentage_commission"],
  },
  parks: {
    apiKey: "park",
    label: "Parks",
    ...
    displayColumns: ["id", "name", "location", "city", "county", "code"],
  },
  cottages: {
    apiKey: "cottages",
    label: "Cottages",
    ...
    displayColumns: ["id", "cottage_name", "location", "cottage_code", "bedrooms", "sleeps"],
  },
  lodges: {
    apiKey: "lodges",
    label: "Lodges",
    ...
    displayColumns: ["id", "park_id", "lodge_name", "lodge_code", "bedrooms", "sleeps"],
  },
  "cruise-extras": {
  ...
  "deletion-codes": {
    ...
    displayColumns: ["id", "code", "description", "is_used"],
  },
};
