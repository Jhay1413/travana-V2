...
import type { OrganizationOverviewTrendPoint } from "@/features/organization/api/organization-overview.api";
...
export function CommissionTrendCard({ trend }: { trend: OrganizationOverviewTrendPoint[] }) {
      ...
      <div className="mb-3 flex items-center justify-between">
        <div>
          ...
          <div className="text-xs text-muted-foreground">
            Bars: agency commission · Line: aggregated monthly target · Green = on/over target
          </div>
        </div>
