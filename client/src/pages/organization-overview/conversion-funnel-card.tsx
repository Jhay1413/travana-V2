...
import type { OrganizationOverviewFunnel } from "@/api/endpoints/organization-overview.api";
...
export function ConversionFunnelCard({ funnel }: { funnel: OrganizationOverviewFunnel }) {
