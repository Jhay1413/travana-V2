                ...
                <Tabs defaultValue="summary" className="w-full">
                  ...
                  <TabsContent value="costings" className="mt-0">
                    ...
                    <div className="mt-3 grid gap-2" data-testid="list-booking-summary-lines">
                      ...
                      <div className="flex items-center justify-between rounded-2xl border border-black/10 bg-black/[0.03] px-3 py-2" data-testid="row-booking-summary-total-commission">
                        <div className="text-xs font-semibold text-black/70" data-testid="text-booking-summary-total-commission-label">Total commission</div>
