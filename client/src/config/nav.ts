...
const AGENT_NAV: NavConfig = [
  {
    ...
    items: [
      ...
      { path: "/destination-guru", label: "Destination Guru", icon: TreePalm },
...
const ORG_ADMIN_NAV: NavConfig = [
  ...
  },
  {
    ...
    items: [
      ...
      { path: "/agency/messaging", label: "Messaging", icon: RadioTower },
      { path: "/hr", label: "HR", icon: HeartHandshake },
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      ...
      { path: "/settings/client-duplicates", label: "Duplicate Clients", icon: CopyCheck },
  ...
  },
  {
    ...
    icon: Bot,
    items: [
      { path: "/settings/bot", label: "Bot Settings", icon: Bot },
      { path: "/settings/knowledge-base", label: "Knowledge Base", icon: BookOpen },
    ],
  },
