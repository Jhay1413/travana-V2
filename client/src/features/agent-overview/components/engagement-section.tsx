...
export function EngagementSection() {
  ...
  return (
    <DashboardCard className="min-w-0" testId="card-engagement">
      <div className="text-base font-semibold">Quote Engagement</div>
            ...
            return (
              ...
              >
                <div className="min-w-0 flex-1">
                  <div
                    className={`truncate text-sm font-semibold ${hasRealClientName ? "" : "italic text-black/55 dark:text-white/55"}`}
