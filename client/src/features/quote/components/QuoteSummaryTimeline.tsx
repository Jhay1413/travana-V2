...
const DEFAULT_TYPOGRAPHY: TimelineTypography = {
  ...
  secondaryRow: "flex items-center gap-2.5 text-[11px] text-black/60",
...
const PANEL_TYPOGRAPHY: TimelineTypography = {
  ...
  secondaryRow: "flex items-center gap-2.5 text-[11px] text-black/75 3xl:text-xs dark:text-white/75",
