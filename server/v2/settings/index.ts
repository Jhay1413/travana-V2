...
import airportRoutes from './airport/airport.routes';
import countryRoutes from './country/country.routes';
import packageTypeRoutes from './package-type/package-type.routes';
import cruiseExtraRoutes from './cruise-extra/cruise-extra.routes';
import cruiseVoyageRoutes from './cruise-voyage/cruise-voyage.routes';
import deletionCodeRoutes from './deletion-code/deletion-code.routes';
...
router.use('/package-types',      packageTypeRoutes);
router.use('/cruise-extras',      cruiseExtraRoutes);
router.use('/cruise-voyages',     cruiseVoyageRoutes);
router.use('/deletion-codes',     deletionCodeRoutes);
