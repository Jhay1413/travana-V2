...
export const emailController = {
  ...
  fetchMessages: asyncHandler(async (req: Request, res: Response) => {
    ...
    const messages = await emailService.fetchMessages(req.params.id as string, folder, limit);
  ...
  fetchMessageById: asyncHandler(async (req: Request, res: Response) => {
    ...
    const message = await emailService.fetchMessageById(req.params.id as string, uid, folder);
